<header class="navbar navbar-expand-lg header container-fluid">
    ...
    <img src="../public/img/user.png" alt="" class="d-none d-sm-block" style="margin-right: 25px;">
    ...
    if ($user_id != null) { ?>
        <div class="btn-group dropleft">
            <a class="btn btn-danger d-none d-md-block dropdown-toggle"  id="nav" data-toggle="dropdown" aria-expanded="false">
                <?= $nombre; ?>
                <?= $apellido; ?>
            </a>
